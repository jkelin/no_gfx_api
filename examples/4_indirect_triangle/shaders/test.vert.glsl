...
layout(push_constant, std140) uniform Push
{
    ...
    _res_ptr_Data _res_vert_indirect_data_;
    _res_ptr_Data _res_frag_indirect_data_;
};
...
void main()
{
    ...
    _res_ptr_Data indirect_data = _res_vert_indirect_data_[gl_DrawID];
    Output vert_out;
    vert_out.pos = vec4(data._res_.verts[vert_id]._res_.pos.xyz, 1.0);
    vert_out.color = indirect_data._res_.verts[vert_id]._res_.color;
